...
<head>
    ...
    <link href="/painel/plugins/bower_components/custom-select/custom-select.css" rel="stylesheet" type="text/css" />
    <link href="/painel/plugins/bower_components/switchery/dist/switchery.min.css" rel="stylesheet" />
    <link href="/painel/plugins/bower_components/bootstrap-select/bootstrap-select.min.css" rel="stylesheet" />
    <link href="/painel/plugins/bower_components/bootstrap-tagsinput/dist/bootstrap-tagsinput.css" rel="stylesheet" />
    <link href="/painel/plugins/bower_components/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css" rel="stylesheet" />
    <link href="/painel/plugins/bower_components/multiselect/css/multi-select.css" rel="stylesheet" type="text/css" />
    <!-- animation CSS -->
    <link href="/painel/css/animate.css" rel="stylesheet">
    <!-- Custom CSS -->
                    ...
                    <div class="white-box">
                        ...
                        <form class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control" placeholder="Objeto da Licitação">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Nº do processo</label>
                                <div class="col-md-12">
                                    <input type="text" name="example-email" class="form-control" placeholder="Ex: 2017-00001">
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <select id="select1" class="form-control">
                                                ...
                                                <option value="lc">Licitação</option>
                                                <option value="cd">Contratação Direta</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <select id="select2" class="form-control" disabled required>
                                                <option data-value="cd" disabled selected>Selecione uma opção</option>
                                                <option data-value="lc" disabled selected>Selecione uma opção</option>
                                                <option data-value="cd" value="Carona">Carona</option>
                                                <option data-value="lc" value="Concorrência">Concorrência</option>
                                                <option data-value="lc" value="Convite">Convite</option>
                                                <option data-value="cd" value="Dispensa de Licitação">Dispensa de Licitação</option>
                                                <option data-value="lc" value="Leilão">Leilão</option>
                                                <option data-value="cd" value="Inexigibilidade">Inexigibilidade</option>
                                                <option data-value="lc" value="Pregão">Pregão</option>
                                                <option data-value="lc" value="Regime Diferenciado de Contratação">Regime Diferenciado de Contratação</option>
                                                <option data-value="cd" value="Sem Licitação">Sem Licitação</option>
                                                <option data-value="lc" value="Tomada de Preço">Tomada de Preço</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
